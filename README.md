...
```bash
git clone https://github.com/VergeTickVanquish/xiaoer-videolab-938.git
cd xiaoer-videolab-938
npm install
npm start
```
...
Powered by a tiny local [`yt-dlp`](https://github.com/VergeTickVanquish/xiaoer-videolab-938) daemon — **1800+ sites** out of the box
...
This tool is a friendly button in front of [`yt-dlp`](https://github.com/VergeTickVanquish/xiaoer-videolab-938), the open-source
...
Standing entirely on the shoulders of [**yt-dlp**](https://github.com/VergeTickVanquish/xiaoer-videolab-938) — this project is
...
<!-- Last updated: 2026-06-06 16:42:48 -->
